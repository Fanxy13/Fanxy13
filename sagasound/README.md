...
SoundCloud im Browser – eigenes Layout, eigene Bibliothek, eigene Empfehlungen.

## Online stellen (GitHub Pages)

1. Branch nach `main` mergen.
2. Repo → **Settings → Pages** → Source: *Deploy from a branch* → `main` / `(root)` → Save.
3. Nach ein, zwei Minuten läuft die App unter `https://fanxy13.github.io/Fanxy13/sagasound/`.

Lokal: `cd sagasound && python3 -m http.server 8000` → <http://localhost:8000>.
